...
update_factor <- function(x, z, p_i, Q, beta, lambda, gamma) {
    .Call('emi_update_factor', PACKAGE = 'emi', x, z, p_i, Q, beta, lambda, gamma)
}
...
#' @export
lf_gd_cov <- function(X, Z_vec, k_factors, lambdas, n_iter, gamma_pq, gamma_beta) {
    .Call('emi_lf_gd_cov', PACKAGE = 'emi', X, Z_vec, k_factors, lambdas, n_iter, gamma_pq, gamma_beta)
}
